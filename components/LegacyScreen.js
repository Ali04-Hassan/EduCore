...
const NAV_KEYWORDS = [
  ...
  { match: ["community"], route: "/community" },
  { match: ["subscription", "pricing", "upgrade"], route: "/pricing" },
  { match: ["leaderboard"], route: "/leaderboard" },
  { match: ["gpa calculator", "gpa"], route: "/gpa-calculator" },
  { match: ["attendance calculator", "attendance"], route: "/attendance-calculator" },
